...
def render():
    ...
    with c1: data_ini = st.date_input("De",  value=datetime(2000,1,1).date(), key="cust_ini", format="DD/MM/YYYY")
    with c2: data_fim = st.date_input("Até", value=datetime.now().date(),     key="cust_fim", format="DD/MM/YYYY")
    with c3:
