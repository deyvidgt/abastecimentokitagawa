# =================================================================
# PAGES/PG_CUSTOS.PY — com filtro de período
# =================================================================
...
def render():
    ...
    st.caption(f"📅 {data_ini} a {data_fim} · {len(df)} registros")
    ...
    botoes_download(st, resumo_cat, "custos",
        f"CENTRO DE CUSTOS — {data_ini} a {data_fim}",
    ...
    # ── Filtros extras e tabela ───────────────────────────────────
    c1, c2 = st.columns([2,4])
    cat_f   = c1.selectbox("Categoria",
